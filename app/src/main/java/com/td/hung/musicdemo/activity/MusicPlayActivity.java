...
public class MusicPlayActivity extends AppCompatActivity implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, SongListRecyclerViewAdapter.OnItemSongClickListener, SongListRecyclerViewAdapter.OnMoreVertClickListener {
    ...
    private void initService() {
        ...
        songList = MusicUtil.newInstance().getSongList(mContext);
    ...
    private Runnable mUpdateTimeTask = new Runnable() {
        ...
        public void run() {
            ...
            txtCurrentDuration.setText("" + MusicUtil.newInstance().milliSecondsToTimer(currentDuration / 1000));
            seekBar.setProgress(MusicUtil.newInstance().getProgressPercentage(currentDuration, totalDuration));
    ...
    public void updateProgressBar() {
        txtTotalDuration.setText("" + MusicUtil.newInstance().milliSecondsToTimer(totalDuration / 1000));
        stopTimeTask = false;
    ...
    public void onStopTrackingTouch(SeekBar seekBar) {
        ...
        currentDuration = MusicUtil.newInstance().progressToTimer(seekBar.getProgress(), totalDuration);
    ...
    public void itemSongClicked(Song song) {
        if (!isMyServiceRunning(MusicService.class)) {
            Intent intent = new Intent(this, MusicService.class);
            intent.putExtra("uri", song.getPath());
            bindService(intent, serviceConnection, BIND_AUTO_CREATE);
        } else {
    ...
    public void onMoreVertClicked(Song song) {
        ...
        Bitmap bitmap = MusicUtil.newInstance().getImageSongFromPath(mContext, song.getPath());
        if (bitmap != null) {
